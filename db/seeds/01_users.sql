...
VALUES (1, 'Partial Fractions', 'http://tutorial.math.lamar.edu/Classes/CalcII/PartialFractions.aspx', 'Partial fraction decomposition tutorial on Paul''s Notes', 'https://www.itweb.co.za/static/pictures/2018/05/resized/-fs-Math-2018.xl.jpg', 'math'),
...
(5, 'String Theory: A Beginner''s Guide','https://www.newscientist.com/article/dn16950-string-theory-a-beginners-guide/', 'String theory is one of the most famous ideas in modern physics, but it is also one of the most confusing. Give this guide a read!', 'https://www.yu.edu/sites/default/files/ThinkstockPhotos-658148844.jpg', 'physics'),
